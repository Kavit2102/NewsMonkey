...
export default function BlogItem(props) {
  ...
  return (
    ...
    >
      <div
        id="source"
        className="bg-success w-fit pt-1 px-2 text-xs text-center absolute right-0 pb-2 rounded-bl-md rounded-tr-md"
      >
        {props.category}
      </div>
      {/* {props.imageUrl ? (
        ...
        <div className="text-warning text-center">Image Unavailable !!!!</div>
      )} */}
